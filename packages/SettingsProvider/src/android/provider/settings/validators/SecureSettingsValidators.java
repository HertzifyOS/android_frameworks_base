...
public class SecureSettingsValidators {
    ...
    static {
        ...
        VALIDATORS.put(Secure.APP_SPOOF_ENABLED, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.APP_SPOOF_DATA, ANY_STRING_VALIDATOR);
        VALIDATORS.put(Secure.APP_SPOOF_PRESETS, ANY_STRING_VALIDATOR);
        VALIDATORS.put(Secure.APP_SPOOF_SHOW_UNINSTALLED, BOOLEAN_VALIDATOR);
    }
}
