...
public class SecureSettingsValidators {
    ...
    static {
        ...
        VALIDATORS.put(Secure.APPSHIELD_HIDE_APPLIST, ANY_STRING_VALIDATOR);
        VALIDATORS.put(Secure.APPSHIELD_HIDE_LAUNCHER, ANY_STRING_VALIDATOR);
        VALIDATORS.put(Secure.APPSHIELD_HIDE_DEVSTATUS, ANY_STRING_VALIDATOR);
        VALIDATORS.put(Secure.APPSHIELD_DETACHED, ANY_STRING_VALIDATOR);
    }
}
